...
def parse_agrs():
    ...
    parser.add_argument('--save_dir', type=str, default='results/came_grad', help='the path to save the models.')
    ...
    parser.add_argument('--came_nu', type=float, default=0.2, help='Fusion coefficient (nu) for CAME-Grad')
